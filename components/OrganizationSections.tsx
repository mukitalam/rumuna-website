    ...
    <>
      ...
      >
        <div
          ...
          className="
            absolute inset-0
            bg-[radial-gradient(circle_at_15%_25%,rgba(200,164,67,0.14),transparent_32%)]
          "
        />
